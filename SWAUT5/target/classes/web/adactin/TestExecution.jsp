...
function executeTestCases()  {
	 ...
	 String testdatapath = path+"/src/test/resources/TestCaseSettings.xls";				
		...
		try {			
			 ...
			 Process pr = Runtime.getRuntime().exec("cmd /c "+ currDir1+"\\assets\\vbs\\adactin.bat");	
		...
		<div class="area-section">
			...
			<div class="content-area">
				...
				<table border="1" class="table">
					<%String filepathEditACStoGL1 = "C:/DemoWorkspace/Adactin/src/test/resources/TestCaseSettings.xls";
