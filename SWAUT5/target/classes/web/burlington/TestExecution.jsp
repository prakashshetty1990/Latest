...
function executeTestCases()  {
	 ...
	 String path = common1.getProperty("BurlingtonWorkspace");
	 ...
	 String testdatapath = path+"/src/test/resources/TestCaseSettings.xls";				
		...
		try {			
			...
			/*  String[] parms = {"cmd.exe", "/c","start"+ currDir1+"/assets/vbs/adactin.bat"};
			 ...
			 pr = Runtime.getRuntime().exec("cmd /c "+ currDir1+"\\assets\\vbs\\burlington.bat "+path);	
...
function KillProcess() {
	<%
	String functionNam = request.getParameter("StopExecution");	 
 	if(functionNam != null){
 		if (functionNam.equals("ExecutionStop")) {
		...
		try{
			if(pr.isAlive()){
			  ...
			  System.out.println("destroyed");
				...
				System.out.println("No ruuning process");
			}
		}
		catch (Exception ex) {
	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="../../web/burlington/default.jsp">Burlington</a></li>
				<li  class="active" class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="../../web/burlington/TestExecution.jsp">Test
						Case Execution </a>
					<ul class="dropdown-menu">
						<li><a href="../../web/burlington/TestExecution.jsp">Execution
								By Test Cases</a></li>
						<li><a href="#">Execution By Category</a></li>
					</ul></li>
				<!-- 	<li><a href="../../web/burlington/TestExecution.jsp">Test Case Execution</a></li> -->
				<li><a href="../../web/burlington/configurations.jsp">App Configurations</a></li>
				<li><a href="../../web/burlington/TestData.jsp">Test Data</a></li>
				<li><a href="../../web/burlington/report.jsp">Results</a></li>
			</ul>
		</div>
		</nav>
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a
				href="../../web/burlington/default.jsp">Burlington</a></li>
		...
		<div class="area-section">
			...
			<div class="content-area">
				...
				<form method="post" id="Execute" role="form">
					<input type="hidden" name="StopExecution"
						value="ExecutionStop" />						
						<nav class="navbar fixed-bottom navbar-light bg-faded">
					<div class="pl-4">
						<button type="submit" class="btn btn-info">
