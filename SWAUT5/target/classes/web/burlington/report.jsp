	...
	<div class="wrapper1">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
			        <a class="dropdown-toggle" data-toggle="dropdown" href="../../web/burlington/TestExecution.jsp">Test Case Execution
			        </a>
			        <ul class="dropdown-menu">
			        <li><a href="../../web/burlington/TestExecution.jsp">Execution By Test Cases</a></li>
			...
			<li><a href="../../web/burlington/configurations.jsp">App Configurations</a></li>
				...
				<li class="active"><a href="../../web/burlington/report.jsp">Results</a></li>
			</ul>
		</div>
		</nav>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="../../web/burlington/default.jsp">Burlington</a></li>
...
<div class="p-container content-area mb-2 col">
        <h4>Click on 'View Reports' button to view Automation execution results</h4>       
            <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">View Reports</button>
         		...
         		%>        											
					<%=
					Displayreports.listDirectory("C:/apache-tomcat-8.5.32/webapps/AutomationResults/Web/Burlington/TestResults/",0,"Burlington")
					%>								
