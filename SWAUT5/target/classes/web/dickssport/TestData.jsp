...
<script type="text/javascript">
	...
	<%Common common1 = new Common();
	 String path = common1.getProperty("DicksSportWorkspace");
	...
	<div class="wrapper1">
		...
		<div class="container-fluid">
			...
			<li><a href="../../web/dickssport/configurations.jsp">App Configurations</a></li>
				<li  class="active"><a href="../../web/dickssport/TestData.jsp">Test Data</a></li>
				<li><a href="../../web/dickssport/report.jsp">Results</a></li>
			</ul>
		</div>
		</nav>
			...
			<div class="content-area">
				...
				<form name="form1" id="form1"
					...
					<div class="pl-4">
						...
						<a href=./web/dickssport/TestExecution.jsp">Back</a></button>
						</div>
					</nav>
