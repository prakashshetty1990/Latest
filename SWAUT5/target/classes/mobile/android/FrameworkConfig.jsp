...
function updateAppConfig()  {
	 ...
	 String functionName = request.getParameter("UpdateConfig");	 
		...
		String testdatapath = "C:/DemoWorkspace/Android/src/test/resources/TestConfiguration.xls";
	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="../../mobile/android/default.jsp">Android</a></li>
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="../../mobile/android/TestExecution.jsp">Test
						Case Execution </a>
					<ul class="dropdown-menu">
						<li><a href="../../mobile/android/TestExecution.jsp">Execution
								By Test Cases</a></li>
						<li><a href="#">Execution By Category</a></li>
					</ul></li>
				<!-- 	<li><a href="../../mobile/android/TestExecution.jsp">Test Case Execution</a></li> -->
				<li class="active"><a
					href="../../mobile/android/configurations.jsp">App Configurations</a></li>
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="#">Android Application</a></li>
			<li class="breadcrumb-item"><a
				href="../../mobile/android/default.jsp">Android</a></li>
			...
			<div class="content-area">
				...
				<form method="post" id="Update" role="form">
					...
					<table class="table table-bordered table-striped">
						...
						<%String filepathEditACStoGL1 = "C:/DemoWorkspace/Android/src/test/resources/TestConfiguration.xls";
