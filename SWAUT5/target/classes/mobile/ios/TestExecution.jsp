...
function executeTestCases()  {
	 ...
	 String path = common1.getProperty("IOSWorkspace");
	 ...
	 String testdatapath = path+"/src/test/resources/TestCaseSettings.xls";				
		...
		try {			
			 ...
			 String[] parms = {"cmd.exe", "/c","start"+ currDir1+"/assets/vbs/ios.bat"};
			 String arg = "cmd /c "+ currDir1+"/assets/vbs/ios.bat";
			 System.out.println(arg);
			 Process pr = Runtime.getRuntime().exec("cmd /c "+ currDir1+"\\assets\\vbs\\ios.bat");	
	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="../../mobile/ios/default.jsp">Android</a></li>
				<li  class="active" class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="../../mobile/ios/TestExecution.jsp">Test
						Case Execution </a>
					<ul class="dropdown-menu">
						<li><a href="../../mobile/ios/TestExecution.jsp">Execution
								By Test Cases</a></li>
						<li><a href="#">Execution By Category</a></li>
					</ul></li>
				<!-- 	<li><a href="../../mobile/ios/TestExecution.jsp">Test Case Execution</a></li> -->
				<li><a href="../../mobile/ios/configurations.jsp">App Configurations</a></li>
				<li><a href="../../mobile/ios/TestData.jsp">Test Data</a></li>
				<li><a href="../../mobile/ios/report.jsp">Results</a></li>
			</ul>
		</div>
		</nav>
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a
				href="../../mobile/ios/default.jsp">Android</a></li>
		...
		<div class="area-section">
			...
			<div class="content-area">
				...
				<table border="1" class="table">
					<%String filepathEditACStoGL1 = "C:/DemoWorkspace/ios/src/test/resources/TestCaseSettings.xls";
