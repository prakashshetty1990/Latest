		...
		String functionName = request.getParameter("CheckOutFromSVN");	 
	 	if(functionName != null){
	 		if (functionName.equals("CheckOutLatestFromSVN")) {
				...
				String path = common1.getProperty("AndroidWorkspace");	 
	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
			        <a class="dropdown-toggle" data-toggle="dropdown" href="../../mobile/ios/TestExecution.jsp">Test Case Execution
			        </a>
			        <ul class="dropdown-menu">
			        <li><a href="../../mobile/ios/TestExecution.jsp">Execution By Test Cases</a></li>
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a
				href="../../mobile/ios/default.jsp" active>IOS</a></li>
			<li class="breadcrumb-item" aria-current="page">IOS Home Page</li>
		</ol>
		</nav>
			...
			<div class="content-area">
				...
				<table border="1" class="table">					
					...
					<tbody>						
						<tr>
							<td>SVN URL</td>							
							<td style="padding: 0"> <input class="form-control" name="svnurl" value="https://Praskash-PC/svn/SeleniumScripts/trunk/ios/trunk"></input>								
							</td>					
						</tr>					
					</thead>					
					</tbody>					
