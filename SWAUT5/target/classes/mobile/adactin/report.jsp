	...
	<div class="wrapper1">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
			        <a class="dropdown-toggle" data-toggle="dropdown" href="../../mobile/adactin/TestExecution.jsp">Test Case Execution
			        </a>
			        <ul class="dropdown-menu">
			        <li><a href="../../mobile/adactin/TestExecution.jsp">Execution By Test Cases</a></li>
			          <li><a href="#">Execution By Category</a></li>			          			         
			        </ul>
			      </li>
			<!-- 	<li><a href="../../mobile/adactin/TestExecution.jsp">Test Case Execution</a></li> -->
			<li><a href="../../mobile/adactin/configurations.jsp">App Configurations</a></li>
				<li><a href="../../mobile/adactin/TestData.jsp">Test Data</a></li>
				<li class="active"><a href="../../mobile/adactin/report.jsp">Results</a></li>
			</ul>
		</div>
		</nav>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="../../mobile/adactin/default.jsp">Adactin</a></li>
...
<div class="p-container content-area mb-2 col">
        <h4>Click on 'View Reports' button to view Automation execution results</h4>       
            <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">View Reports</button>
         		...
         		%>        											
					<%=
					Displayreports.listAndroidDirectory("C:/apache-tomcat-8.5.32/webapps/AutomationResults/Mobile/Adactin/TestResults/",0,"Adactin")
