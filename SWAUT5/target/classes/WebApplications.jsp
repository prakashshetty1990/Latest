	...
	<div class="wrapper" style="margin-left:10px;">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="./WebApplications.jsp">Hybrid Web Applications</a></li>
						...
						<div class="col-12">
								...
								<header	class="headline pb-3 mb-4 border-bottom"> 
									<section class="d-flex flex-wrap align-items-center mt-4">
										<section class="  p-0 d-flex align-items-center animate mr-2 mb-2 rounded shadow-2dp db-card handhover"					 
					 							onclick="window.location.href='./web/adactin/TestExecution.jsp'">
												<div class="image align-items-center">
													<figure class="card-icon m-0 "> 
														<img src="assets/images/adactinlogo.png" alt="" /> 
													</figure>
												</div>				
												<div class="card-title"><b>Adactin Hotel Application</b></div>
										</section>
									</section>
								</header>
							</section>
							<section class="cards-wrapper"> 
								<header	class="headline pb-3 mb-4 border-bottom"> 
									<section class="d-flex flex-wrap align-items-center mt-4">
										<section class="  p-0 d-flex align-items-center animate mr-2 mb-2 rounded shadow-2dp db-card handhover"					 
					 							onclick="window.location.href='./web/burlington/default.jsp'">
												<div class="image align-items-center">
													<figure class="card-icon m-0 "> 
														<img src="assets/images/burlington.jpg" alt="" /> 
													</figure>
												</div>				
												<div class="card-title"><b>Burlington</b></div>
										</section>
									</section>
								</header>
							</section>
							...
							<section class="cards-wrapper"> 
								<header	class="headline pb-3 mb-4 border-bottom"> 
									<section class="d-flex flex-wrap align-items-center mt-4">
										<section class="  p-0 d-flex align-items-center animate mr-2 mb-2 rounded shadow-2dp db-card handhover"					 
					 							onclick="window.location.href='./web/academy/default.jsp'">
												<div class="image align-items-center">
													<figure class="card-icon m-0 "> 
														<img src="assets/images/academy.png" alt="" /> 
													</figure>
												</div>				
												<div class="card-title"><b>Academy Sports</b></div>
										</section>
									</section>
								</header>
							</section>
							<section class="cards-wrapper"> 
								<header	class="headline pb-3 mb-4 border-bottom"> 
									<section class="d-flex flex-wrap align-items-center mt-4">
										<section class="  p-0 d-flex align-items-center animate mr-2 mb-2 rounded shadow-2dp db-card handhover"					 
					 							onclick="window.location.href='./web/bedbath/default.jsp'">
												<div class="image align-items-center">
													<figure class="card-icon m-0 "> 
														<img src="assets/images/bedbath.png" alt="" /> 
													</figure>
												</div>				
												<div class="card-title"><b>BedBath and Beyond</b></div>
										</section>
									</section>
								</header>
							</section>
							<section class="cards-wrapper"> 
								<header	class="headline pb-3 mb-4 border-bottom"> 
									<section class="d-flex flex-wrap align-items-center mt-4">
										<section class="  p-0 d-flex align-items-center animate mr-2 mb-2 rounded shadow-2dp db-card handhover"					 
					 							onclick="window.location.href='./web/dickssport/default.jsp'">
												<div class="image align-items-center">
													<figure class="card-icon m-0 "> 
														<img src="assets/images/dickssporting.png" alt="" /> 
													</figure>
												</div>				
												<div class="card-title"><b>Dicks Sporting Goods</b></div>
										</section>
									</section>
								</header>
							</section>
							...
							<section class="cards-wrapper"> 
								<header	class="headline pb-3 mb-4 border-bottom"> 
									<section class="d-flex flex-wrap align-items-center mt-4">
										<section class="  p-0 d-flex align-items-center animate mr-2 mb-2 rounded shadow-2dp db-card handhover"					 
					 							onclick="window.location.href='./web/rossstore/default.jsp'">
												<div class="image align-items-center">
													<figure class="card-icon m-0 "> 
														<img src="assets/images/rossstore.png" alt="" /> 
													</figure>
												</div>				
												<div class="card-title"><b>Ross Stores</b></div>
										</section>
									</section>
								</header>
							</section>
							<section class="cards-wrapper"> 
								<header	class="headline pb-3 mb-4 border-bottom"> 
									<section class="d-flex flex-wrap align-items-center mt-4">
										<section class="  p-0 d-flex align-items-center animate mr-2 mb-2 rounded shadow-2dp db-card handhover"					 
					 							onclick="window.location.href='./web/micheals/default.jsp'">
												<div class="image align-items-center">
													<figure class="card-icon m-0 "> 
														<img src="assets/images/michaels.png" alt="" /> 
													</figure>
												</div>				
												<div class="card-title"><b>Micheals</b></div>
										</section>
									</section>
								</header>
							</section>
							<section class="cards-wrapper"> 
								<header	class="headline pb-3 mb-4 border-bottom"> 
									<section class="d-flex flex-wrap align-items-center mt-4">
										<section class="  p-0 d-flex align-items-center animate mr-2 mb-2 rounded shadow-2dp db-card handhover"					 
					 							onclick="window.location.href='./web/cucumber/default.jsp'">
												<div class="image align-items-center">
													<figure class="card-icon m-0 "> 
														<img src="assets/images/adactinlogo.png" alt="" /> 
													</figure>
												</div>	
												<div class="card-title"><b>cucumber</b></div>			
										</section>
									</section>
								</header>
							</section>
