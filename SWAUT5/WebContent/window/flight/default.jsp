	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li class="active"><a href="#">Window</a></li>
				<li class="dropdown">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="#">Windows Applications</a></li>
			<li class="breadcrumb-item"><a
				href="../../window/flight/default.jsp" active>Flight</a></li>			
		</ol>
		</nav>
			...
			<div class="content-area">
				...
				<table border="1" class="table">					
					...
					<tbody>						
						<tr>
							<td>SVN URL</td>							
							<td style="padding: 0"> <input class="form-control" name="svnurl" value="https://Praskash-PC/svn/SeleniumScripts/trunk/flight/trunk"></input>								
							</td>					
						</tr>					
					</thead>					
					</tbody>					
