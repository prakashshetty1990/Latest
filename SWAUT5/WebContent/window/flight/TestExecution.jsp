...
function executeTestCases()  {
	 ...
	 String path = common1.getProperty("WindowFlightWorksapce");
	 ...
	 System.out.println("me "+testdatapath);
		...
		try {			
			 ...
			 Process pr = Runtime.getRuntime().exec("cmd /c "+ currDir1+"\\assets\\vbs\\Window.bat");	
	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="../../window/flight/default.jsp">Android</a></li>
				<li  class="active" class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="../../window/flight/TestExecution.jsp">Test
						Case Execution </a>
					<ul class="dropdown-menu">
						<li><a href="../../window/flight/TestExecution.jsp">Execution
								By Test Cases</a></li>
				...
				<li><a href="../../window/flight/report.jsp">Results</a></li>
			</ul>
		</div>
		</nav>
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a
				href="../../window/flight/default.jsp">Flight Window</a></li>
		...
		<div class="area-section">
			...
			<div class="content-area">
				...
				<table border="1" class="table">
					...
					System.out.println(filepathEditACStoGL1);
