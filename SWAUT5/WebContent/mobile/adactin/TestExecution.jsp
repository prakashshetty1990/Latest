...
function executeTestCases()  {
	 ...
	 String testdatapath = path+"/src/test/resources/TestCaseSettings.xls";	
		...
		try {			
			 ...
			 String[] parms = {"cmd.exe", "/c","start"+ currDir1+"/assets/vbs/mobileAdactin.bat"};
			 String arg = "cmd /c "+ currDir1+"/assets/vbs/mobileAdactin.bat";
			 System.out.println(arg);
			 Process pr = Runtime.getRuntime().exec("cmd /c "+ currDir1+"\\assets\\vbs\\mobileAdactin.bat");	
	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="../../mobile/adactin/default.jsp">Android</a></li>
