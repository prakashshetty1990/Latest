...
function updateAppConfig()  {
	 ...
	 String functionName = request.getParameter("UpdateConfig");	 
		...
		String testdatapath = "C:/DemoWorkspace/IOS/src/test/resources/TestConfiguration.xls";
	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a
					href="../../mobile/ios/configurations.jsp">App Configurations</a></li>
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="#">IOS Application</a></li>
			<li class="breadcrumb-item"><a
				href="../../mobile/ios/default.jsp">IOS</a></li>
			...
			<div class="content-area">
				...
				<form method="post" id="Update" role="form">
					...
					<table class="table table-bordered table-striped">
						...
						<%String filepathEditACStoGL1 = "C:/DemoWorkspace/IOS/src/test/resources/TestConfiguration.xls";
