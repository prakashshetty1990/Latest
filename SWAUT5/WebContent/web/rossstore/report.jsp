	...
	<div class="wrapper1">
		...
		<div class="container-fluid">
			...
			<li><a href="../../web/rossstore/configurations.jsp">App Configurations</a></li>
				...
				<li class="active"><a href="../../web/rossstore/report.jsp">Results</a></li>
			</ul>
		</div>
		</nav>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="../../web/rossstore/default.jsp">Ross Store</a></li>
...
<div class="p-container content-area mb-2 col">
        <h4>Click on 'View Reports' button to view Automation execution results</h4>       
            <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">View Reports</button>
         		...
         		%>        											
					<%=
					Displayreports.listDirectory("C:/apache-tomcat-8.5.32/webapps/AutomationResults/Web/Rossstore/TestResults/",0,"Rossstore")
					%>								
