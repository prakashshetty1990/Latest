...
function updateAppConfig()  {
	...
	<% Common common1 = new Common();
	 String path = common1.getProperty("RossStoreWorkspace");
	 %>
	 <%		
	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="../../web/rossstore/default.jsp">Ross Store</a></li>
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="../../web/rossstore/TestExecution.jsp">Test
						Case Execution </a>
					<ul class="dropdown-menu">
						<li><a href="../../web/rossstore/TestExecution.jsp">Execution
								By Test Cases</a></li>
						<li><a href="#">Execution By Category</a></li>
					</ul></li>
				<!-- 	<li><a href="../../web/rossstore/TestExecution.jsp">Test Case Execution</a></li> -->
				<li class="active"><a
					href="../../web/rossstore/configurations.jsp">App Configurations</a></li>
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a
				href="../../web/rossstore/default.jsp">Ross Store</a></li>
