		...
		String functionName = request.getParameter("CheckOutFromSVN");	 
	 	if(functionName != null){
	 		if (functionName.equals("CheckOutLatestFromSVN")) {
				...
				String path = common1.getProperty("AdactinWorkspace");	 
	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li class="active"><a href="#">Adactin</a></li>
				<li class="dropdown">
			        <a class="dropdown-toggle" data-toggle="dropdown" href="../../web/adactin/TestExecution.jsp">Test Case Execution
			        </a>
			        <ul class="dropdown-menu">
			        <li><a href="../../web/adactin/TestExecution.jsp">Execution By Test Cases</a></li>
			          <li><a href="#">Execution By Category</a></li>			          			         
			        </ul>
			      </li>
			<!-- 	<li><a href="../../web/adactin/TestExecution.jsp">Test Case Execution</a></li> -->
			<li><a href="../../web/adactin/configurations.jsp">App Configurations</a></li>
				<li><a href="../../web/adactin/TestData.jsp">Test Data</a></li>
				<li><a href="../../web/adactin/report.jsp">Results</a></li>
			</ul>
		</div>
		</nav>
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a
				href="../../web/adactin/default.jsp" active>Adactin</a></li>
			<li class="breadcrumb-item" aria-current="page">Adactin Home Page</li>
		</ol>
		</nav>
			...
			<div class="content-area">
				...
				<table border="1" class="table">					
					...
					<tbody>						
						<tr>
							<td>SVN URL</td>							
							<td style="padding: 0"> <input class="form-control" name="svnurl" value="https://Praskash-PC/svn/SeleniumScripts/trunk/Adactin/trunk"></input>								
							</td>					
						</tr>					
					</thead>					
					</tbody>					
