...
{
    if (document.getElementsByName("data1_1").value == "Server") {
    	document.getElementsByName("data1_2").disabled='true';
    	document.getElementsByName("data1_2").disabled='true';
        console.log("Hello world!");
    } else {
    	document.getElementsByName("data1_2").disabled='';
    	document.getElementsByName("data1_2").disabled='';
        console.log("Hello world! No"+document.getElementsByName("data1_1").value);
    }
}
</script>
	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a
					href="../../web/adactin/configurations.jsp">App Configurations</a></li>
