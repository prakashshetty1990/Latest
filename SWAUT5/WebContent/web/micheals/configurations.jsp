...
function updateAppConfig()  {
	...
	<% Common common1 = new Common();
	 String path = common1.getProperty("MichaelsWorkspace");
	 %>
	 <%		
	...
	<div class="wrapper">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="../../web/micheals/TestExecution.jsp">Test
						Case Execution </a>
					<ul class="dropdown-menu">
						<li><a href="../../web/micheals/TestExecution.jsp">Execution
								By Test Cases</a></li>
						<li><a href="#">Execution By Category</a></li>
					</ul></li>
				<!-- 	<li><a href="../../web/micheals/TestExecution.jsp">Test Case Execution</a></li> -->
				<li class="active"><a
					href="../../web/micheals/configurations.jsp">App Configurations</a></li>
				<li><a href="../../web/micheals/TestData.jsp">Test Data</a></li>
				<li><a href="../../web/micheals/report.jsp">Results</a></li>
			</ul>
		</div>
		</nav>
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a
				href="../../web/micheals/default.jsp">Michaels</a></li>
